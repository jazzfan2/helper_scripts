...
- on-the-fly editing of the (X)PM-file, re-activating 'bottomShadowColor' (= 'foreground'), 'selectColor' and 'topShadowColor' as gradations along the 'foreground -> background'-color spectrum;
