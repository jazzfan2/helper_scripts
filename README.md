...
- on-the-fly editing of the (X)PM-file, re-activating 'bottomShadowColor' (= 'foreground'), 'selectColor' and 'topShadowColor' 
  as gradations within/beyond the 'foreground'-to-'background' color spectrum;
