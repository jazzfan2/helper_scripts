...
# Description: Mount all external USB-drives, eMMC's and SD-Cards, that are
# physically added to the system. If a password is required for mounting a
# particular volume, 'mount_plugdrives.sh' offers an xterm window popup
# prompting for it.
#
