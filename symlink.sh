...
# Author: R.J.Toscani
# Date: 7 October 2025
# Description: Store an absolute symbolic link to the file selected in the
# file manager into a RAM directory. It presents this in a file manager
# window popping up, from which the link can be moved or copied to a
# desired directory opened in another file manager window.
